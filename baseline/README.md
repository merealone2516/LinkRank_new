...
| **EasyLink** | Huang, H., Widyasari, R., Zhang, T., Irsan, I.C., Shi, J., Ang, H.W., Liauw, F., Ouh, E.L., Shar, L.K., Kang, H.J., et al., 2025. *Back to the Basics: Rethinking Issue-Commit Linking with LLM-Assisted Retrieval.* ICSE 2026. |
| **LinkAnchor** | Akhavan, A., Hosseinpour, A., Heydarnoori, A., Keshani, M., 2025. *LinkAnchor: An Autonomous LLM-Based Agent for Issue-to-Commit Link Recovery.* FSE 2026. (Adapted to the one-to-many setting; evaluated with GPT-OSS-120B as described in Section 4.3 of our paper.) |
